...
## 5a. Скиллы — slash-команды проекта
...
## 5b. Stop хук — напоминание при выходе
...
## 5c. Юнит-тесты — существуют и проходят
...
## 5d. Smoke-тесты — быстрая проверка "работает?"
...
## 5e. Автообновление зависимостей — Dependabot / Renovate
...
## 5f. Установщик хуков — `make hooks` для онбординга
...
## 5g. Оптимизация скиллов — `disable-model-invocation`
