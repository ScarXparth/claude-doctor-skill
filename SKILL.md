...
**Пороги оценки адаптируются по зрелости:**

| Уровень | 🌟 | ✅ | ⚠️ | Низший |
|---------|-----|-----|-----|--------|
| Starter 🌱 | 80%+ Отличный старт | 60%+ На верном пути | 40%+ Есть основа | <40% Начало пути 🚀 |
| Growing 🌿 | 85%+ Отлично | 70%+ Хорошо | 50%+ Средне | <50% Требует внимания 🔧 |
| Mature 🌳 / Pro ⚡ | 90%+ Отлично | 70%+ Хорошо | 50%+ Средне | <50% Плохо 🔴 |

> Для Starter **нет слова "Плохо"** — новичок не виноват что у него нет CI.
...
**Блок "Следующий уровень"** — после ТОП-3, покажи путь роста (3 шага до следующего уровня зрелости). См. [MATURITY.md](layers/MATURITY.md) → "Следующий уровень".
